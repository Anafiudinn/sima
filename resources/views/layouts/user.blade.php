        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <nav class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="{{ route('user.materi.index') }}" class="relative group text-gray-600 hover:text-blue-600 transition-colors duration-300 
                        {{ request()->routeIs('user.materi.index') ? 'text-blue-600 font-semibold' : '' }}">
                        Materi
                        <div class="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full {{ request()->routeIs('user.materi.index') ? 'w-full' : '' }}"></div>
                    </a>

                    <a href="{{ route('user.history.index') }}" class="relative group text-gray-600 hover:text-blue-600 transition-colors duration-300 
                        {{ request()->routeIs('user.history.index') ? 'text-blue-600 font-semibold' : '' }}">
                        History
                        <div class="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full {{ request()->routeIs('user.history.index') ? 'w-full' : '' }}"></div>
                    </a>
            ...
            <div x-show="open" x-cloak @click.away="open = false"
                ...
                <div class="px-2 pt-2 pb-3 space-y-1">
                    ...
                    <a href="{{ route('user.history.index') }}" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors duration-200">History</a>
